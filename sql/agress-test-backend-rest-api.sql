...
--
-- Database: `agress-test-backend-rest-api`
--
...
(5, '2022_10_26_085104_create_products_table', 1);
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `deskripisi` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `variasi` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
